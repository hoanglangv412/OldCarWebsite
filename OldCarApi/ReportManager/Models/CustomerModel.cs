...
namespace OldCarApi.Models
{
    public class CustomerModel
    {
        ...
        public CustomerModel(int customer_id, string customer_avatar, string customer_name, DateTime? customer_birth, string customer_email, string customer_address, string customer_phone, DateTime? customer_begindate, string account_name, string account_password, int? account_role, DateTime? account_lastLogin)
        {
            ...
            Customer_begindate = customer_begindate;
        ...
        public CustomerModel checkExist(string username, string password)
        {
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    returnCustomer.Account_role = (byte)dr["Account_role"];
